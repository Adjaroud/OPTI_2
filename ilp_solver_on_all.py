...
# ==========================================
# FONCTIONS DE RÉSOLUTION (INCHANGÉES)
# ==========================================
...
def resoudre_ilp_iteration(G, partitions, ponts, edges_forcees):
    ...
    for cycle in cycles_base:
        # Extraire les arêtes du cycle (u, v)
        aretes_du_cycle = []
...
def sauvegarder_graphe(T, n_sommets, n_aretes, chemin_sortie):
    """ Sauvegarde au format : N_sommets N_arêtes 0 + liste des arêtes """
    with open(chemin_sortie, 'w') as f:
        # On écrit 0 pour le poids total car il n'est pas utilisé ici
...
if __name__ == "__main__":
    ...
    dossier_sortie = "solutions"

    # Création du dossier de sortie s'il n'existe pas
    if not os.path.exists(dossier_sortie):
        os.makedirs(dossier_sortie)

    # Parcours du dossier d'instances
    ...
    print("\n" + "=" * 40)
    print("Traitement terminé pour toutes les instances.")
    print("=" * 40)
